 ...
 * @author said
 */
public class reporteDocenteConParametro {

    public void getReporte(String ruta, int facultad) throws ClassNotFoundException, InstantiationException, SQLException, IllegalAccessException {
